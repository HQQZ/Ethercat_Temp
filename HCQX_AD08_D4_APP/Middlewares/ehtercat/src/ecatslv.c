...
UINT16 StartInputHandler(void)
{
    ...
    */
    ...
    cycleTimeSync1 = 0;//        HW_EscReadDWord(cycleTimeSync1, ESC_DC_SYNC1_CYCLETIME_OFFSET);//??硬件没有sync1 暂时先直接赋值0
...
//	UINT16 Value2;
//	Value2=0x05;
//	HW_EscWriteWord(Value2,0x0012);/* 测试设置从站别名 */
...
void ECAT_Main(void)
{
//	static UINT16 ALEventReg_last=0;
//	static UINT16 ALStatus_last=0;
    UINT16 ALEventReg;
...
//	if(ALEventReg_last!=ALEventReg)
//	{
//        debug3("ALEventReg=%02x--------------------------\r\n",ALEventReg);
//		ALEventReg_last=ALEventReg;
//	}

//	if(nAlStatus!=ALStatus_last)
//	{
//	    debug3("nAlStatus=%d\r\n",nAlStatus);
//		ALStatus_last=nAlStatus;
//	}
