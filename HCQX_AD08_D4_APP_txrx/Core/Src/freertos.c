...
void MX_FREERTOS_Init(void) {
    ...
    EthercatTaskHandle = osThreadNew(ethercat_task, NULL, &EthercatTask_attributes);
...
/* USER CODE BEGIN Header_ethercat_task */
/**
* @brief Function implementing the EthercatTask thread.
* @param argument: Not used
* @retval None
*/
/* USER CODE END Header_ethercat_task */
void ethercat_task(void *argument)
{
    /* USER CODE BEGIN ethercat_task */
