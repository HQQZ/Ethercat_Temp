...
#define MAX_GlOABLE_PDO  1 /**< \brief 全局PDO，不属于Module*/
#define MAX_AXES         4 /**< \brief Number of supported axes*/
...
/*ECATCHANGE_START(V5.11) CiA402 1*/
   UINT32   aEntries[16]; /**< \brief Entry buffer*/
/*ECATCHANGE_END(V5.11) CiA402 1*/
...
/** \brief 0x17A0 (RxPDO) data structure*/
typedef struct OBJ_STRUCT_PACKED_START {
   UINT16   u16SubIndex0; /**< \brief SubIndex 0*/
   UINT32   aEntries[2]; /**< \brief Entry buffer*/
} OBJ_STRUCT_PACKED_END
...
/** \brief 0x1BA0 (TxPDO) data structure*/
typedef struct OBJ_STRUCT_PACKED_START {
   UINT16   u16SubIndex0; /**< \brief SubIndex 0*/
   UINT32   aEntries[2]; /**< \brief Entry buffer*/
} OBJ_STRUCT_PACKED_END
...
typedef struct OBJ_STRUCT_PACKED_START {
   UINT16   u16SubIndex0; /**< \brief SubIndex 0*/
   UINT16   aEntries[MAX_AXES+MAX_GlOABLE_PDO]; /**< \brief 4个module的PDO+1个全局PDO，Entry buffer (number of entries depends on the supported axis, each axis requires one entry)*/
} OBJ_STRUCT_PACKED_END
TOBJ1C12;
...
/** \brief 0x6099 回零速度 data structure*/
typedef struct OBJ_STRUCT_PACKED_START {
   UINT16   u16SubIndex0; 
   INT32    Fast; 
   INT32    Slow; 
...
/** \brief Object 0x60FE (IO输出) data structure*/
typedef struct OBJ_STRUCT_PACKED_START {
   UINT16   u16SubIndex0; /**< \brief SubIndex 0*/
   uint32_t    u32PhysicalOutputs; /**< \brief Interpolation period*/
   uint32_t    u32BitMask; /**< \brief Interpolation index*/
} OBJ_STRUCT_PACKED_END
TOBJ60FE;
/** @}*/
...
/** \brief 0x3101 脉冲输出方法*/
typedef struct OBJ_STRUCT_PACKED_START {
   uint16_t     u16SubIndex0; 
   uint16_t     Pulse_Method[MAX_AXES]; /* 轴1输入功能选择。4个字节，每个字节表示一个输入 */
} OBJ_STRUCT_PACKED_END
TOBJ3101;

/** \brief 0x3105 输入IO功能选择*/
typedef struct OBJ_STRUCT_PACKED_START {
   uint16_t     u16SubIndex0; 
   uint16_t     Axis_Function[MAX_AXES]; /* 轴1输入功能选择。4个字节，每个字节表示一个输入 */
   
} OBJ_STRUCT_PACKED_END
TOBJ3125;

/** \brief 0x3107 输出口3输出功能选择*/
typedef struct OBJ_STRUCT_PACKED_START {
   uint16_t     u16SubIndex0; 
   uint16_t     OUT2_Function[MAX_AXES]; /* 轴1输入功能选择。4个字节，每个字节表示一个输入 */
} OBJ_STRUCT_PACKED_END
TOBJ3107;
...
typedef struct OBJ_STRUCT_PACKED_START {
   uint16_t     u16SubIndex0; 
   uint16_t     Axis_FilterTime[MAX_AXES]; /* 轴1输入功能选择。4个字节，每个字节表示一个输入 */
} OBJ_STRUCT_PACKED_END
TOBJ3109;
...
typedef struct OBJ_STRUCT_PACKED_START {
   uint16_t     u16SubIndex0; 
   uint16_t     Axis_HomingOutTime[MAX_AXES];
} OBJ_STRUCT_PACKED_END
TOBJ310A;
...
typedef struct OBJ_STRUCT_PACKED_START
{
    ...
    INT32 objTargetPosition; /**< \brief Target Position (0x607A)*/
	INT32 objHomingOffset;                  /* 原点偏移 (0x7C) */
	...
	INT16 objHomingMethed;                  /* 回零方法 (0x6098) */
	TOBJ6099 objHomingVelocity;             /* 回零速度 (0x6099) */
	UINT32 objHomingAcceleration;           /* 回零加速度 (0x609A) */
	UINT32 objPositionOffset;               /* pp模式位置偏移 (0x60B0) */
    TOBJ60C2 objInterpolationTimePeriod; /**< \brief Interpolation Time Period (0x60C2)*/
	INT32 objFollowingErrActualValue; /**< \brief Following Err ActualValue (0x60F4)*/
	UINT32 objDigitalInputs; /**< \brief  DigitalInputs (0x60FD)*/
	TOBJ60FE objDigitalOutputs;             /* 输出IO （0x60FE）*/
    INT32 objTargetVelocity; /**< \brief Target Velocity (0x60FF)*/
...
typedef struct
{
	...
	UINT8       i8CurrentAxisNo;/**< \brief 轴号*/
	UINT8       i8ErrorHappened;/**< \brief 故障发送标记*/
 ...
 */   
OBJCONST UCHAR OBJMEM aName0x1C12[] = "RxPDO assign0\000RxPDO assign1\000\377";
 ...
 * In this example no specific entry name is defined ("SubIndex xxx" is used)
 */
//OBJCONST UCHAR OBJMEM aName0x1C13[] = "TxPDO assign\000TxPDO assign\000\377";
/** @}*/
...
/*ECATCHANGE_START(V5.11) CiA402 1*/
   ...
   {DEFTYPE_UNSIGNED32, 0x20, ACCESS_READ|ACCESS_WRITE_PREOP}, /* SubIndex 010*/
   {DEFTYPE_UNSIGNED32, 0x20, ACCESS_READ|ACCESS_WRITE_PREOP}, /* SubIndex 011*/
   {DEFTYPE_UNSIGNED32, 0x20, ACCESS_READ|ACCESS_WRITE_PREOP}, /* SubIndex 012*/
   {DEFTYPE_UNSIGNED32, 0x20, ACCESS_READ|ACCESS_WRITE_PREOP}, /* SubIndex 013*/
   {DEFTYPE_UNSIGNED32, 0x20, ACCESS_READ|ACCESS_WRITE_PREOP}, /* SubIndex 014*/
   {DEFTYPE_UNSIGNED32, 0x20, ACCESS_READ|ACCESS_WRITE_PREOP}, /* SubIndex 015*/
   {DEFTYPE_UNSIGNED32, 0x20, ACCESS_READ|ACCESS_WRITE_PREOP}}; /* SubIndex 016*/
/*ECATCHANGE_END(V5.11) CiA402 1*/
...
OBJCONST UCHAR OBJMEM aName0x17A0[] = "Device RxPDO\000\377";
OBJCONST UCHAR OBJMEM aName0x1BA0[] = "Device TxPDO\000\377";
...
/* （0x2100）FPGA版本  */
OBJCONST TSDOINFOENTRYDESC    OBJMEM sEntryDesc0x2100[] = {DEFTYPE_UNSIGNED16, 0x10, ACCESS_READWRITE};
OBJCONST UCHAR OBJMEM aName0x2100[] = "FPGA Version";

/* （0x2101）FPGA ID  */
OBJCONST TSDOINFOENTRYDESC    OBJMEM sEntryDesc0x2101[] = {DEFTYPE_UNSIGNED16, 0x10, ACCESS_READWRITE};
OBJCONST UCHAR OBJMEM aName0x2101[] = "FPGA ID";

/* （0x2102）FPGA缓存个数 */
OBJCONST TSDOINFOENTRYDESC    OBJMEM sEntryDesc0x2102[] = {DEFTYPE_UNSIGNED16, 0x10, ACCESS_READWRITE};
OBJCONST UCHAR OBJMEM aName0x2102[] = "FPGA Cache Number";

/* （0x3101）脉冲输出类型  */
OBJCONST TSDOINFOENTRYDESC    OBJMEM sEntryDesc0x3101[] = {
    {DEFTYPE_UNSIGNED8, 0x08, ACCESS_READ},   
    {DEFTYPE_UNSIGNED16, 0x10, ACCESS_READWRITE},
	{DEFTYPE_UNSIGNED16, 0x10, ACCESS_READWRITE},
	{DEFTYPE_UNSIGNED16, 0x10, ACCESS_READWRITE},
    {DEFTYPE_UNSIGNED16, 0x10, ACCESS_READWRITE}};
OBJCONST UCHAR OBJMEM aName0x3101[] = "Pulse output method\000\377";

/* （0x3105）输入功能选择  */
OBJCONST TSDOINFOENTRYDESC    OBJMEM sEntryDesc0x3125[] ={
    {DEFTYPE_UNSIGNED8, 0x08, ACCESS_READ},   
    {DEFTYPE_UNSIGNED16, 0x10, ACCESS_READWRITE},
	{DEFTYPE_UNSIGNED16, 0x10, ACCESS_READWRITE},
	{DEFTYPE_UNSIGNED16, 0x10, ACCESS_READWRITE},
    {DEFTYPE_UNSIGNED16, 0x10, ACCESS_READWRITE}};
OBJCONST UCHAR OBJMEM aName0x3125[] = "Ch0 Inputs Function\000\377";
OBJCONST UCHAR OBJMEM aName0x3126[] = "Ch1 Inputs Function\000\377";
OBJCONST UCHAR OBJMEM aName0x3127[] = "Ch2 Inputs Function\000\377";
OBJCONST UCHAR OBJMEM aName0x3128[] = "Ch3 Inputs Function\000\377";

/* （0x3106）输入IO极性选择  */
OBJCONST TSDOINFOENTRYDESC    OBJMEM sEntryDesc0x3106[] = {DEFTYPE_UNSIGNED32, 0x20, ACCESS_READWRITE};
OBJCONST UCHAR OBJMEM aName0x3106[] = "Inputs Polarity";

/* （0x3107）输出功能选择  */
OBJCONST TSDOINFOENTRYDESC    OBJMEM sEntryDesc0x3107[] = {
    {DEFTYPE_UNSIGNED8, 0x08, ACCESS_READ},   
    {DEFTYPE_UNSIGNED16, 0x10, ACCESS_READWRITE},
	{DEFTYPE_UNSIGNED16, 0x10, ACCESS_READWRITE},
	{DEFTYPE_UNSIGNED16, 0x10, ACCESS_READWRITE},
    {DEFTYPE_UNSIGNED16, 0x10, ACCESS_READWRITE}};
OBJCONST UCHAR OBJMEM aName0x3107[] = "Outputs Function\000\377";

/* （0x3108）输出极性选择  */
OBJCONST TSDOINFOENTRYDESC    OBJMEM sEntryDesc0x3108[] = {DEFTYPE_UNSIGNED32, 0x20, ACCESS_READWRITE};
OBJCONST UCHAR OBJMEM aName0x3108[] = "Outputs Polarity";

/* （0x3109）输入滤波时间  */
OBJCONST TSDOINFOENTRYDESC    OBJMEM sEntryDesc0x3109[] ={
    {DEFTYPE_UNSIGNED8, 0x08, ACCESS_READ},   
    {DEFTYPE_UNSIGNED16, 0x10, ACCESS_READWRITE},
	{DEFTYPE_UNSIGNED16, 0x10, ACCESS_READWRITE},
	{DEFTYPE_UNSIGNED16, 0x10, ACCESS_READWRITE},
    {DEFTYPE_UNSIGNED16, 0x10, ACCESS_READWRITE}};
OBJCONST UCHAR OBJMEM aName0x3109[] = "Inputs Filter Time\000\377";


/* （0x310A）回零超时时间  */
OBJCONST TSDOINFOENTRYDESC    OBJMEM sEntryDesc0x310A[] ={
    {DEFTYPE_UNSIGNED8, 0x08, ACCESS_READ},   
    {DEFTYPE_UNSIGNED16, 0x10, ACCESS_READWRITE},
	{DEFTYPE_UNSIGNED16, 0x10, ACCESS_READWRITE},
	{DEFTYPE_UNSIGNED16, 0x10, ACCESS_READWRITE},
    {DEFTYPE_UNSIGNED16, 0x10, ACCESS_READWRITE}};
OBJCONST UCHAR OBJMEM aName0x310A[] = "Homing Out Time\000\377";


/* （0x310B)外部输出控制  */
OBJCONST TSDOINFOENTRYDESC    OBJMEM sEntryDesc0x310B[] = {DEFTYPE_UNSIGNED16, 0x10, ACCESS_READWRITE};
OBJCONST UCHAR OBJMEM aName0x310B[] = "External Output";



/* （0x310C）外部输入状态  */
OBJCONST TSDOINFOENTRYDESC    OBJMEM sEntryDesc0x310C[] = {DEFTYPE_UNSIGNED16, 0x10, ACCESS_READ};
OBJCONST UCHAR OBJMEM aName0x310C[] = "External Input State";

/* （0x3111）清除错误  */
OBJCONST TSDOINFOENTRYDESC    OBJMEM sEntryDesc0x3111[] = {DEFTYPE_UNSIGNED16, 0x10, ACCESS_READWRITE};
OBJCONST UCHAR OBJMEM aName0x3111[] = "Clear Error";

/* （0x3112）全局错误标记  */
OBJCONST TSDOINFOENTRYDESC    OBJMEM sEntryDesc0x3112[] = {DEFTYPE_UNSIGNED16, 0x10, ACCESS_READ};
OBJCONST UCHAR OBJMEM aName0x3112[] = "Global Error Status";

/* （0x3120）FPGA轴同步配置  */
OBJCONST TSDOINFOENTRYDESC    OBJMEM sEntryDesc0x3120[] = {DEFTYPE_UNSIGNED16, 0x10, ACCESS_READWRITE};
OBJCONST UCHAR OBJMEM aName0x3120[] = "FPGA Axis Sync Config";
...
OBJCONST TSDOINFOENTRYDESC    OBJMEM sEntryDesc0x6065 = {DEFTYPE_INTEGER32, 0x20, (ACCESS_READWRITE|OBJACCESS_RXPDOMAPPING)};
...
/** \brief Object 0x607C (Homing Offset) entry description*/
OBJCONST TSDOINFOENTRYDESC    OBJMEM sEntryDesc0x607C = {DEFTYPE_INTEGER32, 0x20, (ACCESS_READWRITE|OBJACCESS_RXPDOMAPPING)};
/** \brief Object 0x607C (Homing Offset) object name*/
OBJCONST UCHAR OBJMEM aName0x607C[] = "Homing Offset";
...
/** 
 * \brief Object 0x6099 (SHoming Velocity) entry description
 * 
 * Subindex 0<br>
 * Subindex 1 : Fast<br>
 * Subindex 2 : Slow
 */
OBJCONST TSDOINFOENTRYDESC    OBJMEM sEntryDesc0x6099[] = {
    {DEFTYPE_UNSIGNED8, 0x08, ACCESS_READ},   
    {DEFTYPE_UNSIGNED32, 0x20, ACCESS_READWRITE|OBJACCESS_RXPDOMAPPING},
    {DEFTYPE_UNSIGNED32, 0x20, ACCESS_READWRITE|OBJACCESS_RXPDOMAPPING}}; 

/** \brief Object 0x6099 (Homing Velocity) object and entry names*/
OBJCONST UCHAR OBJMEM aName0x6099[] = "Homing Velocity";


/** \brief Object 0x609A (Homing Acceleration) entry description*/
OBJCONST TSDOINFOENTRYDESC    OBJMEM sEntryDesc0x609A = {DEFTYPE_INTEGER32, 0x20, ACCESS_READWRITE};
 ...
 * Subindex 2 : Interpolation time index
 */
OBJCONST TSDOINFOENTRYDESC    OBJMEM asEntryDesc0x60F4[] = {
    {DEFTYPE_UNSIGNED8, 0x08, ACCESS_READ},
    {DEFTYPE_INTEGER8, 0x20, ACCESS_READWRITE|OBJACCESS_RXPDOMAPPING}};
/** \brief Object 0x60F4 (Following error actual value) entry description*/
OBJCONST TSDOINFOENTRYDESC    OBJMEM sEntryDesc0x60F4 = {DEFTYPE_INTEGER32, 0x20, (ACCESS_READWRITE|OBJACCESS_RXPDOMAPPING)};
 ...
 * (x > 0)
 */
OBJCONST TSDOINFOENTRYDESC    OBJMEM asEntryDesc0xF010[5] = {
   {DEFTYPE_UNSIGNED8, 0x08, ACCESS_READ},
 ...
 * (x > 0)
 */
OBJCONST TSDOINFOENTRYDESC    OBJMEM asEntryDesc0xF030[5] = {
   {DEFTYPE_UNSIGNED8, 0x08, (ACCESS_READ|ACCESS_WRITE)},
   {DEFTYPE_UNSIGNED32, 0x20, (ACCESS_READ|ACCESS_WRITE)},
   {DEFTYPE_UNSIGNED32, 0x20, (ACCESS_READ|ACCESS_WRITE)},
   {DEFTYPE_UNSIGNED32, 0x20, (ACCESS_READ|ACCESS_WRITE)},
   {DEFTYPE_UNSIGNED32, 0x20, (ACCESS_READ|ACCESS_WRITE)}
};
 ...
 * (x > 0)
 */
OBJCONST TSDOINFOENTRYDESC    OBJMEM asEntryDesc0xF050[5] = {
   {DEFTYPE_UNSIGNED8, 0x08, ACCESS_READ},
   {DEFTYPE_UNSIGNED32, 0x20, ACCESS_READ},
   {DEFTYPE_UNSIGNED32, 0x20, ACCESS_READ},
   {DEFTYPE_UNSIGNED32, 0x20, ACCESS_READ},
...
#ifdef _CiA402_
= {5,0x17A0,0x1600,0x01610,0x1620,0x1630}
#endif
;
...
//#ifdef _CiA402_
//= {5,0x1BA0,0x1A00,0x1A10,0x1A20,0x1A30}
//#endif
;
/** @}*/
...
#ifdef _CiA402_
= {4,{DEVICE_PROFILE_TYPE,DEVICE_PROFILE_TYPE,DEVICE_PROFILE_TYPE,DEVICE_PROFILE_TYPE}}
#endif
;
...
#ifdef _CiA402_
= {0,{0x219800,0x219800,0x219800,0x219800}}
#endif
;
...
#ifdef _CiA402_
= {4,{0x219800,0x219800,0x219800,0x219800}}
#endif
;
/** @}*/
/* object 2100 FPGA版本 */
#ifdef _CiA402_
uint16_t  FPGA_Version=0;  /**< \brief FPGA版本*/
#endif
;
extern uint16_t  FPGA_Version;

/* object 2101 FPGA ID */
#ifdef _CiA402_
uint32_t  FPGA_ID=0;  /**< \brief FPGA ID*/
#endif
;
extern uint32_t  FPGA_ID;

/* object 2102 FPGA 缓存 */
#ifdef _CiA402_
uint32_t  FPGA_CacheNum=0;  /**< \brief FPGA 缓存*/
#endif
;
extern uint32_t  FPGA_CacheNum;

/* object 3101 脉冲输出类型 */
#ifdef _CiA402_
TOBJ3101  PulseType={4,0,0,0,0};  /**< \brief 脉冲输出类型*/
#endif
;
extern TOBJ3101  PulseType;

/* object 3106 输入极性选择 */
#ifdef _CiA402_
uint32_t  InputPolarity=0;  /**< \brief （0x3106）输入功能选择*/
#endif
;
extern uint32_t  InputPolarity;


/* object 3107 输出功能选择 */
#ifdef _CiA402_
TOBJ3107  OutputFunction={4,1,1,1,1};  /**< \brief （0x3107） 输出功能选择,01:使能输出*/
#endif
;
extern TOBJ3107  OutputFunction;


/* object 3108 输出极性选择 */
#ifdef _CiA402_
uint32_t  OutputPolarity=0;  /**< \brief （0x3108） 输出极性选择*/
#endif
;
extern uint32_t  OutputPolarity;


/* object 3109 输入滤波时间 */
#ifdef _CiA402_
TOBJ3109  InputFilterTime={4,{10000,10000,10000,10000}}  /**< \brief （0x3109） 输入滤波时间,单位us*/
#endif
;
extern TOBJ3109  InputFilterTime;


/* object 310A 回零超时时间 */
#ifdef _CiA402_
TOBJ310A  HomingOutTime={4,{50000,50000,50000,50000}}  /**< \brief （0x310A） 回零超时时间,单位us*/
#endif
;
extern TOBJ310A  HomingOutTime;


/* object 310B 外部输出控制 */
#ifdef _CiA402_
uint16_t  ExternalOutput=0  /**< \brief （0x310B） 输入滤波时间*/
#endif
;
extern uint16_t  ExternalOutput;



/* object 310C 外部输入状态 */
#ifdef _CiA402_
uint16_t  ExternalInput=0  /**< \brief （0x310C） 输入滤波时间*/
#endif
;
extern uint16_t  ExternalInput;

/* object 3111 清除错误 */
#ifdef _CiA402_
uint16_t  ClearError=0  /**< \brief （0x3111） 清除错误*/
#endif
;
extern uint16_t  ClearError;

/* object 3112 全局错误标记 */
#ifdef _CiA402_
uint16_t  GlobalErrorStatus=0  /**< \brief （0x3112） 全局错误标记*/
#endif
;
extern uint16_t  GlobalErrorStatus;


/* object 3120 FPGA 轴同步配置 */
#ifdef _CiA402_
uint16_t  FPGA_SyncConfig=1  /**< \brief （0x3120） 轴同步配置*/
#endif
;
extern uint16_t  FPGA_SyncConfig;

/* object 3125 Ch0输入功能选择 */
#ifdef _CiA402_
TOBJ3125  Ch0_InputSelect={4,2,3,4,0}  /**< \brief （0x3125）Ch0输入功能选择*/
#endif
;
extern TOBJ3125  Ch0_InputSelect;

/* object 3126 Ch1输入功能选择 */
#ifdef _CiA402_
TOBJ3125  Ch1_InputSelect={4,2,3,4,0}  /**< \brief （0x3125）Ch0输入功能选择*/
#endif
;
extern TOBJ3125  Ch1_InputSelect;

/* object 3127 Ch2输入功能选择 */
#ifdef _CiA402_
TOBJ3125  Ch2_InputSelect={4,2,3,4,0}  /**< \brief （0x3125）Ch0输入功能选择*/
#endif
;
extern TOBJ3125  Ch2_InputSelect;

/* object 3128 Ch3输入功能选择 */
#ifdef _CiA402_
TOBJ3125  Ch3_InputSelect={4,2,3,4,0}  /**< \brief （0x3125）Ch0输入功能选择*/
#endif
;
extern TOBJ3125  Ch3_InputSelect;


PROTO TOBJ17A0 DeviceRxPDOMap
#ifdef _CiA402_
 = {2, {0x310B0010,0x31110010}}
#endif
;

PROTO TOBJ1BA0 DeviceTxPDOMap
#ifdef _CiA402_
 = {2, {0x310C0010,0x31120010}}
#endif
;
...
= {
/*ECATCHANGE_START(V5.11) CiA402 1*/
{3, {0x60400010,0x607A0020,0x60600010}},    /* TOBJ1600*/
/*ECATCHANGE_END(V5.11) CiA402 1*/
{2, {0x60400010,0x607A0020}}, /*TOBJ1601*/
{2, {0x60400010,0x60FF0020}}, /*TOBJ1602*/
/*ECATCHANGE_START(V5.11) CiA402 1*/
{5, {0x603F0010,0x60410010,0x60610010,0x60640020,0x606C0020,0x00000008}}, /*TOBJ1A00*/
/*ECATCHANGE_END(V5.11) CiA402 1*/
{2, {0x60410010,0x60640020}}, /*TOBJ1A01*/
{2, {0x60410010,0x606C0020}},/*TOBJ1A02*/
...
#ifdef _CiA402_
= {/* Object 0x1C12 */
//   {NULL,NULL, 0x1C12, {DEFTYPE_UNSIGNED16, MAX_AXES+MAX_GlOABLE_PDO | (OBJCODE_ARR << 8)}, asPDOAssignEntryDesc, aName0x1C12, &sRxPDOassign, NULL, NULL, 0x0000 },
   /* Object 0x1C13 */
//   {NULL,NULL, 0x1C13, {DEFTYPE_UNSIGNED16, MAX_AXES+MAX_GlOABLE_PDO | (OBJCODE_ARR << 8)}, asPDOAssignEntryDesc, aName0x1C13, &sTxPDOassign, NULL, NULL, 0x0000 },
    /* Object 0xF000 */
...
/*ECATCHANGE_START(V5.11) CiA402 1*/
    /* Object 0x1600 */
    {NULL,NULL, 0x1600, {DEFTYPE_PDOMAPPING, 16 | (OBJCODE_REC << 8)}, asEntryDesc0x1600, aName0x1600, NULL, NULL, NULL, 0x0000 },
/*ECATCHANGE_END(V5.11) CiA402 1*/
    /* Object 0x1601 */
...
/*ECATCHANGE_START(V5.11) CiA402 1*/
   /* Object 0x1A00 */
   {NULL,NULL, 0x1A00, {DEFTYPE_PDOMAPPING, 16 | (OBJCODE_REC << 8)}, asEntryDesc0x1A00, aName0x1A00, NULL, NULL, NULL, 0x0000 },	
/*ECATCHANGE_END(V5.11) CiA402 1*/
   /* Object 0x1A01 */
   ...
   /* Object 0x6065 */
   {NULL,NULL, 0x6065, {DEFTYPE_INTEGER32 , 0 | (OBJCODE_VAR << 8)}, &sEntryDesc0x6065, aName0x6065, NULL, NULL, NULL, 0x0000 },
   /* Object 0x606C */
   ...
   /* Object 0x6098 */
   {NULL,NULL, 0x6098, {DEFTYPE_INTEGER16 , 0 | (OBJCODE_VAR << 8)}, &sEntryDesc0x6098, aName0x6098, NULL, NULL, NULL, 0x0000 },
  
   /* Object 0x6099 */
   {NULL,NULL, 0x6099, {DEFTYPE_RECORD , 2 | (OBJCODE_REC << 8)}, sEntryDesc0x6099, aName0x6099, NULL, NULL, NULL, 0x0000 },
  
   /* Object 0x609A */
   {NULL,NULL, 0x609A, {DEFTYPE_INTEGER32 , 0 | (OBJCODE_VAR << 8)}, &sEntryDesc0x609A, aName0x609A, NULL, NULL, NULL, 0x0000 },
  
    /* Object 0x60B0 */
   {NULL,NULL, 0x60B0, {DEFTYPE_INTEGER32 , 0 | (OBJCODE_VAR << 8)}, &sEntryDesc0x609A, aName0x60B0, NULL, NULL, NULL, 0x0000 },
  
   /* Object 0x60C2 */
   {NULL,NULL, 0x60C2, {DEFTYPE_RECORD , 2 | (OBJCODE_REC << 8)}, asEntryDesc0x60C2, aName0x60C2, NULL, NULL, NULL, 0x0000 },
   
   /* Object 0x60C2 */
   {NULL,NULL, 0x60F4, {DEFTYPE_INTEGER32 , 0 | (OBJCODE_REC << 8)}, asEntryDesc0x60F4, aName0x60F4, NULL, NULL, NULL, 0x0000 },
   
   
   /* Object 0x60FD */
   {NULL,NULL, 0x60FD, {DEFTYPE_INTEGER32 , 0 | (OBJCODE_VAR << 8)}, &sEntryDesc0x60FF, aName0x60FF, NULL, NULL, NULL, 0x0000 },
 ...
 *\brief 用户自定义对象字典
 */
PROTO TOBJECT    OBJMEM DefUserObjDic[]
#ifdef _CiA402_
= {
   /* Object 0x17A0 RX PDO */
   {NULL,NULL, 0x17A0, {DEFTYPE_PDOMAPPING, 2 | (OBJCODE_REC << 8)}, asEntryDesc0x1600, aName0x17A0, &DeviceRxPDOMap, NULL, NULL, 0x0000 }, 
   
   
   /* Object 0x1BA0 TX PDO */
   {NULL,NULL, 0x1BA0, {DEFTYPE_PDOMAPPING, 2 | (OBJCODE_REC << 8)}, asEntryDesc0x1A00, aName0x1BA0, &DeviceTxPDOMap, NULL, NULL, 0x0000 }, 
   
   /* Object 0x2100 FPGA Version */
   {NULL,NULL, 0x2100, {DEFTYPE_UNSIGNED16 , 0| (OBJCODE_VAR << 8)}, sEntryDesc0x2100, aName0x2100, &FPGA_Version, NULL, NULL, 0x0000 },	
   	
   /* Object 0x2101 FPGA ID */
   {NULL,NULL, 0x2101, {DEFTYPE_UNSIGNED16 , 0| (OBJCODE_VAR << 8)}, sEntryDesc0x2102, aName0x2101, &FPGA_ID, NULL, NULL, 0x0000 },	
   	
   /* Object 0x2102 FPGA Cache Num */
   {NULL,NULL, 0x2102, {DEFTYPE_UNSIGNED16 , 0| (OBJCODE_VAR << 8)}, sEntryDesc0x2102, aName0x2102, &FPGA_CacheNum, NULL, NULL, 0x0000 },	
   	
   
   
   /* Object 0x3101 脉冲输出方法 */
   {NULL,NULL, 0x3101, {DEFTYPE_RECORD , 4| (OBJCODE_REC << 8)}, sEntryDesc0x3101, aName0x3101, &PulseType, NULL, NULL, 0x0000 },	
   	

   /* Object 0x3105 输入功能选择 */
   //{NULL,NULL, 0x3105, {DEFTYPE_RECORD , 4 | (OBJCODE_REC << 8)}, sEntryDesc0x3105, aName0x3105, &InputSelect, NULL, NULL, 0x0000 },	
   	
   /* Object 0x3106 输入极性选择 */
   {NULL,NULL, 0x3106, {DEFTYPE_UNSIGNED32 , 0| (OBJCODE_VAR << 8)}, sEntryDesc0x3106, aName0x3106, &InputPolarity, NULL, NULL, 0x0000 },	
   	
   /* Object 0x3107 输出功能 */
   {NULL,NULL, 0x3107, {DEFTYPE_RECORD , 4| (OBJCODE_REC << 8)}, sEntryDesc0x3107, aName0x3107, &OutputFunction, NULL, NULL, 0x0000 },	

   /* Object 0x3108 输出极性 */
   {NULL,NULL, 0x3108, {DEFTYPE_UNSIGNED32 , 0| (OBJCODE_VAR << 8)}, sEntryDesc0x3108, aName0x3108, &OutputPolarity, NULL, NULL, 0x0000 },	
      
   /* （0x3109）输入滤波时间  */
   {NULL,NULL, 0x3109, {DEFTYPE_RECORD , 4 | (OBJCODE_REC << 8)}, sEntryDesc0x3109, aName0x3109, &InputFilterTime, NULL, NULL, 0x0000 },

   /* （0x310A）回零超时时间  */
   {NULL,NULL, 0x310A, {DEFTYPE_RECORD , 4 | (OBJCODE_REC << 8)}, sEntryDesc0x310A, aName0x310A, &HomingOutTime, NULL, NULL, 0x0000 },
   
   /* Object 0x310B 外部输出 */
   {NULL,NULL, 0x310B, {DEFTYPE_UNSIGNED16 , 0| (OBJCODE_VAR << 8)}, sEntryDesc0x310B, aName0x310B, &ExternalOutput, NULL, NULL, 0x0000 },	
   
   /* Object 0x310C 外部输入 */
   {NULL,NULL, 0x310C, {DEFTYPE_UNSIGNED16 , 0| (OBJCODE_VAR << 8)}, sEntryDesc0x310C, aName0x310C, &ExternalInput, NULL, NULL, 0x0000 },	
	
   /* Object 0x3111 清除错误 */
   {NULL,NULL, 0x3111, {DEFTYPE_UNSIGNED16 , 0| (OBJCODE_VAR << 8)}, sEntryDesc0x3111, aName0x3111, &ClearError, NULL, NULL, 0x0000 },	
   
   /* Object 0x3112 全局错误状态 */
   {NULL,NULL, 0x3112, {DEFTYPE_UNSIGNED16 , 0| (OBJCODE_VAR << 8)}, sEntryDesc0x3112, aName0x3112, &GlobalErrorStatus, NULL, NULL, 0x0000 },	
	
   /* Object 0x3120 FPGA轴同步配置 */
   {NULL,NULL, 0x3120, {DEFTYPE_UNSIGNED16 , 0| (OBJCODE_VAR << 8)}, sEntryDesc0x3120, aName0x3120, &FPGA_SyncConfig, NULL, NULL, 0x0000 },	
	
   /* Object 0x3125 Ch0输入功能选择 */
   {NULL,NULL, 0x3125, {DEFTYPE_RECORD , 4 | (OBJCODE_REC << 8)}, sEntryDesc0x3125, aName0x3125, &Ch0_InputSelect, NULL, NULL, 0x0000 },	
   
   /* Object 0x3126 Ch1输入功能选择 */
   {NULL,NULL, 0x3126, {DEFTYPE_RECORD , 4 | (OBJCODE_REC << 8)}, sEntryDesc0x3125, aName0x3126, &Ch1_InputSelect, NULL, NULL, 0x0000 },	
   	
   /* Object 0x3127 Ch2输入功能选择 */
   {NULL,NULL, 0x3127, {DEFTYPE_RECORD , 4 | (OBJCODE_REC << 8)}, sEntryDesc0x3125, aName0x3127, &Ch2_InputSelect, NULL, NULL, 0x0000 },	
   	
   /* Object 0x3128 Ch3输入功能选择 */
   {NULL,NULL, 0x3128, {DEFTYPE_RECORD , 4 | (OBJCODE_REC << 8)}, sEntryDesc0x3125, aName0x3128, &Ch3_InputSelect, NULL, NULL, 0x0000 },	
