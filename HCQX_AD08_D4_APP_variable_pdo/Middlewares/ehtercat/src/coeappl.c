...
TOBJECT    OBJMEM GenObjDic[] = {
    ...
    /* Object 0x1011 */
    {NULL,NULL,0x1011, {DEFTYPE_RECORD, 1 | (OBJCODE_REC << 8)}, asEntryDesc0x1011, aName0x1011, acRestore, NULL, NULL, 0x0000 },
    /* Object 0x1018 */
