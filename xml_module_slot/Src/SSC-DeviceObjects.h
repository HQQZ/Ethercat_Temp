...
#define MODULE_OBJECT_INCREMENT 0 /**< \brief Increment for Module object with the index between 0x2000 and 0xBFFF*/
#define MODULE_PDO_OBJECT_INCREMENT 0 /**< \brief Increment for Module object with the index from 0x1600 to 0x17FF and from 0x1A00 to 0x1BFF*/
